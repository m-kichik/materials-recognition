...
def main():
    ...
    val_images_path = "val2017_cropped_blurred"

    with open(
        "captions_augmented_val_no_small_final.json", "r"
    ) as f:
    ...
    print(f"Mean inference time for image and text: {mean_batch_time / val_batch_size:.3f} s.")
